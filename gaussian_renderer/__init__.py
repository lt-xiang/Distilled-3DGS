...
def render(viewpoint_camera, pc : GaussianModel, 
    ...
    #dropout 3DGS
    if itrain == 1:
        if iteration > 15000 and iteration % 1000 == 0 and iteration < 25_000:    
            ...
            factor = (iteration - 500) / (15_000 - 500)
            drop_rate = 0.2 * factor
            print(f"factor: {factor}, drop_rate: {drop_rate}")
